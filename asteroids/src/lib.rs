...
pub async fn run() {
    ...
    loop {
        ...
        // того, что этот проект показывает. Стадии 2–4 пока пусты — двигать и сталкивать нечего, пока
        // в игре нет корабля, пуль и астероидов, — но они названы здесь, чтобы каркас кадра был виден
